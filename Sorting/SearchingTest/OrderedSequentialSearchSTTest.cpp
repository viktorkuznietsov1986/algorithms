...
#include "OrderedSequentialSearchST.h"
#include <string>
...
{
	TEST_CLASS(OrderedSequentialSearchSTTest)
	{
	public:

		TEST_METHOD(OrderedSequentialSearchST_BasicFlowTest)
		{
			// TODO: Your test code here
			OrderedSequentialSearchST<int, std::string> st;
			st.put(1, "test1");
			st.put(5, "test5");
			st.put(2, "test2");
