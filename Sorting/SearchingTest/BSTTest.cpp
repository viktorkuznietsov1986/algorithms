...
namespace SearchingTest
{
	...
	public:
		...
		TEST_METHOD(BST_BasicFlowTest)
		{
			...
			/*float c = st.avgCompares();

			Assert::IsTrue(st.avgCompares() == 3.6);*/
		...
		TEST_METHOD(BST_AverageComparesTest)
		{
			BST<char, int> st;
			st.put('E', 1);
			st.put('E', 12);
			...
			Assert::IsTrue(st.avgCompares() == 3.5);
		}
